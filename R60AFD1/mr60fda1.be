  ...
  static word = {
    ...
    0x80: {
      ...
      "word": {
        ...
        0x12: { "name": "TBD" },
        0x0A: { "name": "Residence time setting",
                "config": true },
        0x0B: { "name": "Residence monitoring",
                "properties": micradar.wonoff,
                "config": true },
        0x0D: { "name": "Fall sensitivity",
                "config": true },
        0x0E: { "name": "Height percentage" },
    ...
    0x83: {
      ...
      "word": {
        ...
        0x0C: { "name": "Fall time setting",
                "config": true },
        0x05: { "name": "Stationary residence",
